...
public class QLSVView extends JFrame {
    ...
    public Student getStudent() {
        ...
        if (!StringInputHandler.CheckStringLegal(textField_1.getText(), "Mã sinh viên") /*&& (!this.model.checkLoop(textField_1.getText()))*/) {
            textField_1.setText("");
            hasError = true;
        }
        String id = textField_1.getText();
        ArrayList<Student> std = this.model.getListStudent();// Lấy nội dung của textFieldID
        for (Student student : std) {
            if (student.getStudentID().equals(id)) {
                // Nếu trùng thì hiển thị thông báo và kết thúc hàm
    ...
    public void refresh() {
        ...
        ArrayList<Student> stdt0 = this.model.getListStudent();
        for (Student st : stdt0) {
            this.model.insert(st);
        }*/
    }
